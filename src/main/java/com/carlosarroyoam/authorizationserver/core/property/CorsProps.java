...
/**
 * Propiedades de configuración CORS enlazadas desde el prefijo {@code application.cors} (orígenes,
 * métodos, cabeceras permitidas y expuestas y uso de credenciales).
 */
@Component
